...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, CommentNumEvent> consumerFactory() {
        JsonDeserializer<CommentNumEvent> jsonDeserializer = new JsonDeserializer<>(CommentNumEvent.class);
     ...
     */
    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, CommentNumEvent>> factory(
            ConsumerFactory<String, CommentNumEvent> consumerFactory
    ) {
